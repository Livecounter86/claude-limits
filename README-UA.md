...
Репозиторій: https://github.com/Livecounter86/claude-limits
...
Раз на 90 секунд, і ще раз — у момент відкриття меню, але якщо з останнього
запиту минуло менше 90 секунд, повторне відкриття меню запит не робить —
щоб не впертися в ліміт API. "Оновити зараз" у меню завжди тягне дані
негайно. Опитується лише залогінений акаунт.
